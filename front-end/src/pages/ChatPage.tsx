...
export const ChatPage: React.FC = () => {
  ...
  // Auth context for preserved drafts
  const { preservedPrompt, preservedAttachments } = useAuth();
    ...
    <div className="flex h-screen w-screen overflow-hidden bg-white dark:bg-zinc-950 font-sans text-zinc-900 dark:text-zinc-100">
      ...
      <div className="flex flex-1 flex-col h-full overflow-hidden">
        ...
        <Composer
          ...
          onOpenVoice={handleOpenVoice}
          isSending={isSending}
          initialDraft={preservedPrompt}
          initialAttachments={preservedAttachments}
        />
      </div>

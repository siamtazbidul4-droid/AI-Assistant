...
{
  icon: <Sparkles className="h-4 w-4 text-indigo-500" />,
  title: 'AI Skills vs Academic Degrees',
  desc: 'Analysis on practical AI proficiency versus traditional PhD certificates',
  prompt: 'বর্তমান যুগে প্রথাগত একাডেমিক সার্টিফিকেট বা পিএইচডির (PhD) চেয়ে প্র্যাকটিক্যাল এআই (AI) টুলসের দক্ষতা ও টেকনিক্যাল জ্ঞান কেন বেশি গুরুত্বপূর্ণ— একজন পিএইচডি ধারীর চেয়ে একজন এআই দক্ষ মানুষের কাজের গতি ও দক্ষতার তুলনা করে বিস্তারিত আলোচনা করুন।',
},
{
  icon: <Sparkles className="h-4 w-4 text-indigo-500" />,
  title: 'Bangladesh Education History',
  desc: 'Origins and primary causes behind the creation of the academic system in Bangladesh',
  prompt: 'বাংলাদেশের একাডেমিক বা শিক্ষা ব্যবস্থা কোথা থেকে এবং কীভাবে তৈরি হলো এবং এটি তৈরির মূল কারণ কি মূলত শ্রমিক বা কেরানি বাড়ানোর বিষয়টি নিয়ে বিস্তারিত আলোচনা করুন।',
},
  {
  icon: <Sparkles className="h-4 w-4 text-indigo-500" />,
  title: 'Youth Employment Analysis',
  desc: 'Insights & discussion on graduate unemployment in Bangladesh',
  prompt: 'বাংলাদেশের শিক্ষিত বেকার সমস্যা ও এর সম্ভাব্য সমাধান নিয়ে বিস্তারিত আলোচনা করুন।',
},
];
      ...
      {messages.length === 0 ? (
        <div className="flex min-h-full flex-col items-center justify-center p-6 text-center max-w-2xl mx-auto my-auto animate-in fade-in duration-300">
          ...
          <p className="mt-3 max-w-md text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
            Powered by Siam's Chatbot & Live Chat API. Native bilingual support for Bengali and English with real-time streaming, voice conversations, and file analysis.
          </p>
